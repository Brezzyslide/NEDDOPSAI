...
export const BLUEPRINT_REGISTRY: RegistryEntry[] = [
  // ── Clinical: Care & Support Plans ──────────────────────────────────────────
  {
    ...
    title: "Care Plan",
    purpose: "Document an individual participant's care needs, goals and the supports required to meet them.",
    category: "clinical",
  ...
  // ── Behaviour Support ─────────────────────────────────────────────────────────
  {
    ...
    purpose: "Review a participant's behaviour support plan for currency, effectiveness and compliance.",
    category: "behaviour",
  ...
  },
  {
    ...
    purpose: "Analyse the antecedents, behaviours and consequences to identify triggers and inform support strategies.",
    category: "behaviour",
  ...
  // ── Restrictive Practices ─────────────────────────────────────────────────────
  {
    ...
    purpose: "Assess the risks associated with the use of a restrictive practice for a participant.",
    category: "behaviour",
    supportedModes: ["risk_assessment"],
  ...
  },
  {
    ...
    purpose: "Compare proposed restrictive practices against least restrictive alternatives to justify use.",
    category: "behaviour",
  ...
  },
  {
    ...
    purpose: "Prepare documentation required for regulatory authorisation of a restrictive practice.",
    category: "behaviour",
    supportedModes: ["authorisation"],
  ...
  },
  {
    ...
    purpose: "Review and respond to an identified unauthorised restrictive practice incident.",
    category: "behaviour",
    supportedModes: ["review"],
  ...
  },
  {
    ...
    purpose: "Review staff performance and competency against role requirements and service standards.",
    category: "workforce",
  ...
  // ── Policy & Governance Documents ────────────────────────────────────────────
  {
    ...
    title: "Policy",
    purpose: "Create or review an organisational policy document to guide staff conduct and service delivery.",
    category: "governance",
    supportedModes: ["create", "review", "revise"],
