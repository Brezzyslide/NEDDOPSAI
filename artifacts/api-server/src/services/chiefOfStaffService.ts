...
const ROUTING_RULES: RouteRule[] = [
  ...
  // Marketing
  { keywords: ["marketing strategy", "positioning", "value proposition"], capabilities: ["marketing.strategy"], weight: 8 },
  { keywords: ["campaign", "marketing campaign", "promotion", "referral campaign"], capabilities: ["marketing.campaign"], weight: 8 },
  { keywords: ["content strategy", "content calendar", "blog", "article", "copy"], capabilities: ["marketing.content_strategy"], weight: 7 },
  { keywords: ["brand", "branding", "brand voice", "brand identity"], capabilities: ["marketing.brand"], weight: 7 },
  { keywords: ["social media", "facebook", "instagram", "linkedin", "twitter"], capabilities: ["marketing.social_media"], weight: 8 },
  { keywords: ["website copy", "landing page", "newsletter", "email campaign"], capabilities: ["marketing.website_content", "marketing.email_campaign"], weight: 7 },
  { keywords: ["stakeholder communication", "provider communication", "media release", "press release", "holding statement", "crisis communication"], capabilities: ["communications.external", "communications.media", "communications.crisis"], weight: 8 },
  { keywords: ["marketing report", "campaign performance", "marketing analytics", "engagement", "conversion"], capabilities: ["marketing.performance_review", "reporting.marketing"], weight: 6 },
  // Generic
