...
export const WORKER_PROFILES: WorkerProfile[] = [
  ...
  {
    id: "wp_knowledge_documentation_specialist",
    code: "knowledge_documentation_specialist_profile",
    displayName: "Knowledge & Documentation Specialist - Worker Profile",
    description: "Current-v2 controlled knowledge and documentation profile. May read knowledge repositories, document metadata, version history, templates, artifacts and provenance; analyse document control, lifecycle, metadata, taxonomy, retrieval quality, duplication, supersession, review dates and knowledge gaps; and draft controlled-document packages, metadata recommendations and artifact-generation requests. Controlled publication, authoritative metadata mutation, supersession, archival status change and template publication require approval. Professional meaning changes, fabricated provenance, silent historical rewriting, access-control bypass and unknown-currentness promotion are prohibited.",
    ...
    allowedApplicationCategories: [],
    prohibitedActions: [
      "rewrite_professional_conclusion",
      "change_policy_meaning",
      "change_clinical_or_bsp_conclusion",
      "change_restrictive_practice_conclusion",
      "alter_financial_truth",
      "change_worker_compliance_conclusion",
      "rewrite_historical_record",
      "rewrite_case_note",
      "alter_incident_fact",
      "alter_completed_audit_evidence",
      "fabricate_approval",
      "fabricate_version_lineage",
      "fabricate_provenance",
      "fabricate_source_identity",
      "declare_unknown_evidence_current",
      "delete_authoritative_evidence_to_resolve_conflict",
      "bypass_access_control",
      "invent_missing_professional_content",
      "silently_alter_approved_document",
      "publish_controlled_document_without_approval",
    ],
    approvalRequiredActions: [
      "controlled_publication",
      "mutate_authoritative_metadata",
      "supersede_controlled_document",
      "change_archival_status",
      "change_document_owner",
      "publish_approved_template",
      "move_controlled_knowledge_location",
      "external_publication",
      "delete_controlled_document",
      "update_document_register",
      "generate_controlled_docx_pdf_artifact",
      "apply_template_to_controlled_document",
    ],
    riskLevel: "high",
    status: "active",
    version: "1.0.0",
...
export const ROLE_TO_PROFILES: Record<string, string[]> = {
  ...
  knowledge_documentation_specialist: ["knowledge_documentation_specialist_profile"],
