...
export const BUSINESS_CAPABILITIES: BusinessCapability[] = [
  ...
  },
  {
    ...
    description: "Review incident, safeguarding, chronology and immediate-risk implications of a restrictive-practice concern. General RP governance belongs to the future Authorised Program Officer.",
  ...
  },
  {
    ...
    description: "Assess RP authority status, registers, authorised versus unauthorised use, governance suitability, escalation, and reduction/elimination obligations. Future APO-owned; not executable while APO DNA is pending.",
    category: "restrictive_practice", packCode: "compliance",
  ...
  },
  {
    ...
    description: "Prepare monthly RP reporting reconciliation and governance review from usage, authority, incident, consent and reporting-period records. Future APO-owned; not executable while APO DNA is pending.",
    category: "restrictive_practice", packCode: "compliance",
    eligibleRoles: ["authorised_program_officer"],
    requiredWorkerProfiles: [], requiredExecutionChannels: [], requiredConnectorCategories: [],
    defaultRiskLevel: "critical", defaultApprovalRequired: true,
