...
describe("archiveCatalogueEntry", () => {
  it("archives a non-active specialist (dna_pending)", async () => {
    const pending = makeRow({ executionStatus: "dna_pending", specialistCode: "executive_assistant" });
    ...
    const result = await archiveCatalogueEntry("executive_assistant", "user_123");
