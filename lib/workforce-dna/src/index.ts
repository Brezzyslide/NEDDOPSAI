...
export { BEHAVIOUR_SUPPORT_IMPLEMENTATION_SPECIALIST_DNA } from "./profiles/behaviourSupportImplementationSpecialist.js";
...
export { KNOWLEDGE_DOCUMENTATION_SPECIALIST_DNA } from "./profiles/knowledgeDocumentationSpecialist.js";
